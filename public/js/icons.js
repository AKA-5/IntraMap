...
const Icons = {
  ...
  restaurant: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.84 3.75 3.97V22h2.5v-9.03C11.34 12.84 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z"/>
  </svg>`,

  // Restroom icon - Simplified and cleaner
  restroom: `<svg viewBox="0 0 24 24" fill="#000000">
  ...
  exit: `<svg viewBox="0 0 24 24" fill="#000000">
  ...
  stairs: `<svg viewBox="0 0 24 24" fill="#000000">
  ...
  elevator: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14l-4-4h8l-4 4zm0-10l4 4H8l4-4z"/>
  </svg>`,

  // ATM icon
  atm: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
    <circle cx="12" cy="12" r="2"/>
  </svg>`,

  // Parking icon
  parking: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M13 3H6v18h4v-6h3c3.31 0 6-2.69 6-6s-2.69-6-6-6zm.2 8H10V7h3.2c1.1 0 2 .9 2 2s-.9 2-2 2z"/>
  </svg>`,

  // Information icon
  info: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
  </svg>`,

  // Shop/Store icon
  shop: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M20 4H4v2h16V4zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6h1zm-9 4H6v-4h6v4z"/>
  </svg>`,

  // Cafe/Coffee icon
  cafe: `<svg viewBox="0 0 24 24" fill="#000000">
  ...
  medical: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M19 3H5c-1.1 0-1.99.9-1.99 2L3 19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 11h-4v4h-4v-4H6v-4h4V6h4v4h4v4z"/>
  </svg>`,

  // Security icon
  security: `<svg viewBox="0 0 24 24" fill="#000000">
    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
  </svg>`,

  // Help/Customer Service icon
  help: `<svg viewBox="0 0 24 24" fill="#000000">
